...
static const char *minisaver_cmd[] = { "minisaver", NULL };
...
static const Key keys[] = {
	...
	{ 0,                         XK_KP_Down,          spawn,          {.v = next_player_cmd} },
	{ 0,                         XK_KP_Begin,          spawn,          {.v = pause_player_cmd} },
	{ 0,                         XK_KP_End,          spawn,          {.v = pos_sub_cmd} },
	{ 0,                         XK_KP_Next,          spawn,          {.v = pos_add_cmd} },
	{ 0,                         XK_KP_Left,          spawn,          {.v = vol_sub_cmd} },
	{ 0,                         XK_KP_Right,          spawn,          {.v = vol_add_cmd} },
	{ 0,                         XK_KP_Up,          spawn,          {.v = rewind_cmd} },
	{ 0,                         XK_KP_Page_Up,          spawn,          {.v = minisaver_cmd} },
	TAGKEYS(                        XK_1,                                  0)
	TAGKEYS(                        XK_2,                                  1)
	TAGKEYS(                        XK_3,                                  2)
	TAGKEYS(                        XK_4,                                  3)
